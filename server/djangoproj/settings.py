...
ALLOWED_HOSTS = ['localhost', 'nianatasha44-8000.theianext-1-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
CSRF_TRUSTED_ORIGINS = ['https://nianatasha44-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
